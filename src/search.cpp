...
uint32_t contcorr_hash_4ply(unsigned idxA, unsigned idxB, unsigned idxC, unsigned idxD) {
    ...
    // for N=32768: inner P=3527 (top-1 at 2-ply), mid P=2111 (top-1 at
    // 3-ply conditional on inner=3527), outer P=5167 (top-1 at 4-ply
    // conditional on 3527,2111; std=2.339, chi2/mean=0.005).
    // Don't SPSA-tune: hash multipliers have no smooth optimum.
    constexpr uint64_t primeHashMult2Ply = 3527;
    constexpr uint64_t primeHashMult3Ply = 2111;
    constexpr uint64_t primeHashMult4Ply = 5167;
