...
void update_correction_history(const Position& pos,
    ...
    if (m.is_ok())
    {
        ...
        const int     scaledB  = scales[agree] * bonus;
        (*(ss - 2)->continuationCorrectionHistory)[pc][to].update(scaledB * 126 / 16384, ex2);
        (*(ss - 4)->continuationCorrectionHistory)[pc][to].update(scaledB * 63 / 16384, ex4);
    }
}
