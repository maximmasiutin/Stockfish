...
void update_correction_history(const Position& pos,
    ...
    if (m.is_ok())
    {
        ...
        const int    bonus2 = bonus * 129 / 128;
        const int    bonus4 = bonus * 61 / 128;
        shared.scaled((*(ss - 2)->continuationCorrectionHistory)[pc][to]) << bonus2;
        shared.scaled((*(ss - 4)->continuationCorrectionHistory)[pc][to]) << bonus4;
    }
}
