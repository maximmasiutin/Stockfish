...
uint32_t contcorr_hash_3ply(unsigned idx2, unsigned idx3, unsigned idx4) {
    // Two-prime Horner hash. Primes chosen by FFT enumeration over the
    ...
    constexpr uint32_t primeHashMult3Ply = 1009;
    return (idx2 * primeHashMult2Ply + idx3) * primeHashMult3Ply + idx4;
}
...
void Search::Worker::do_move(
  Position& pos, const Move move, StateInfo& st, const bool givesCheck, Stack* const ss) {
    ...
    if (ss != nullptr)
    {
        ...
        (ss + 1)->contcorrHash = contcorr_hash_3ply(
          (ss - 1)->contcorrIndex, (ss - 2)->contcorrIndex, (ss - 3)->contcorrIndex);
    }
}
...
void Search::Worker::do_null_move(Position& pos, StateInfo& st, Stack* const ss) {
    ...
    (ss + 1)->contcorrHash =
      contcorr_hash_3ply((ss - 1)->contcorrIndex, (ss - 2)->contcorrIndex, (ss - 3)->contcorrIndex);
}
