...
void Search::Worker::iterative_deepening() {
    ...
    for (int i = 7; i > 0; --i)
    {
        ...
        (ss - i)->continuationCorrectionHistory = &continuationCorrectionHistory[NO_PIECE_TYPE][0];
  ...
  Position& pos, const Move move, StateInfo& st, const bool givesCheck, Stack* const ss) {
    ...
    if (ss != nullptr)
    {
        ...
        ss->continuationCorrectionHistory =
          &continuationCorrectionHistory[type_of(dirtyPiece.pc)][move.to_sq()];
    }
}
...
void Search::Worker::do_null_move(Position& pos, StateInfo& st, Stack* const ss) {
    ...
    ss->continuationCorrectionHistory = &continuationCorrectionHistory[NO_PIECE_TYPE][0];
}
