...
void Search::Worker::iterative_deepening() {
    ...
    for (int i = 7; i > 0; --i)
    {
        ...
        (ss - i)->continuationCorrectionHistory = &sharedHistory.contCorrHash[0];
...
void Search::Worker::do_move(
  Position& pos, const Move move, StateInfo& st, const bool givesCheck, Stack* const ss) {
    ...
    if (ss != nullptr)
    {
        ...
        size_t contCorrSlot =
          (pos.pawn_key() ^ (Key(dirtyPiece.pc) << 6 | move.to_sq())) & (CONTCORR_HASH_SLOTS - 1);
        ss->continuationCorrectionHistory = &sharedHistory.contCorrHash[contCorrSlot];
    }
}
...
void Search::Worker::do_null_move(Position& pos, StateInfo& st, Stack* const ss) {
    ...
    ss->continuationCorrectionHistory = &sharedHistory.contCorrHash[0];
}
...
void Search::Worker::clear() {
    ...
    sharedHistory.clear_contcorr_range(7, numaThreadIdx, numaTotal);
