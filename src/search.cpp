...
int correction_value(const Worker& w, const Position& pos, const Stack* const ss) {
    ...
    if ((ss - 1)->currentMove.is_ok())
    {
        ...
        auto read = [](uint16_t w_, CorrTag tag) -> int {
...
void update_correction_history(const Position& pos,
    ...
    if ((ss - 1)->currentMove.is_ok())
    {
        ...
        auto update = [](JointCorrSlot& s, CorrTag tag, int b) {
        ...
        update(workerThread.jointCorrectionHistory[ss->contcorrIdxB], ss->contcorrTagB,
