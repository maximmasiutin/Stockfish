...
INCBIN(KBPvKrtbw, "KBPvK.rtbw");
INCBIN(KBPvKrtbz, "KBPvK.rtbz");
INCBIN(KBvKrtbw, "KBvK.rtbw");
INCBIN(KBvKrtbz, "KBvK.rtbz");
INCBIN(KBvKBrtbw, "KBvKB.rtbw");
INCBIN(KBvKBrtbz, "KBvKB.rtbz");
INCBIN(KBvKNrtbw, "KBvKN.rtbw");
INCBIN(KBvKNrtbz, "KBvKN.rtbz");
INCBIN(KBvKPrtbw, "KBvKP.rtbw");
INCBIN(KBvKPrtbz, "KBvKP.rtbz");
INCBIN(KNNvKrtbw, "KNNvK.rtbw");
INCBIN(KNNvKrtbz, "KNNvK.rtbz");
INCBIN(KNPvKrtbw, "KNPvK.rtbw");
INCBIN(KNPvKrtbz, "KNPvK.rtbz");
INCBIN(KNvKrtbw, "KNvK.rtbw");
INCBIN(KNvKrtbz, "KNvK.rtbz");
INCBIN(KNvKNrtbw, "KNvKN.rtbw");
INCBIN(KNvKNrtbz, "KNvKN.rtbz");
...
INCBIN(KQvKPrtbw, "KQvKP.rtbw");
INCBIN(KQvKPrtbz, "KQvKP.rtbz");
...
INCBIN(KRvKNrtbw, "KRvKN.rtbw");
INCBIN(KRvKNrtbz, "KRvKN.rtbz");
INCBIN(KRvKPrtbw, "KRvKP.rtbw");
INCBIN(KRvKPrtbz, "KRvKP.rtbz");
    ...
    if (paths.empty() || paths == "<empty>")
    {
        if (UCI::state == UCI::State::Looping)
        {
            ...
            if (memory_tables.begin() == memory_tables.end())
            {
                ...
                register_memory_table(gKBPvKrtbwData, "KBPvK.rtbw");
                register_memory_table(gKBPvKrtbzData, "KBPvK.rtbz");
                register_memory_table(gKBvKrtbwData, "KBvK.rtbw");
                register_memory_table(gKBvKrtbzData, "KBvK.rtbz");
                register_memory_table(gKBvKBrtbwData, "KBvKB.rtbw");
                register_memory_table(gKBvKBrtbzData, "KBvKB.rtbz");
                register_memory_table(gKBvKNrtbwData, "KBvKN.rtbw");
                register_memory_table(gKBvKNrtbzData, "KBvKN.rtbz");
                register_memory_table(gKBvKPrtbwData, "KBvKP.rtbw");
                register_memory_table(gKBvKPrtbzData, "KBvKP.rtbz");
                register_memory_table(gKNNvKrtbwData, "KNNvK.rtbw");
                register_memory_table(gKNNvKrtbzData, "KNNvK.rtbz");
                register_memory_table(gKNPvKrtbwData, "KNPvK.rtbw");
                register_memory_table(gKNPvKrtbzData, "KNPvK.rtbz");
                register_memory_table(gKNvKrtbwData, "KNvK.rtbw");
                register_memory_table(gKNvKrtbzData, "KNvK.rtbz");
                register_memory_table(gKNvKNrtbwData, "KNvKN.rtbw");
                register_memory_table(gKNvKNrtbzData, "KNvKN.rtbz");
                ...
                register_memory_table(gKQvKPrtbwData, "KQvKP.rtbw");
                register_memory_table(gKQvKPrtbzData, "KQvKP.rtbz");
                ...
                register_memory_table(gKRvKNrtbwData, "KRvKN.rtbw");
                register_memory_table(gKRvKNrtbzData, "KRvKN.rtbz");
                register_memory_table(gKRvKPrtbwData, "KRvKP.rtbw");
                register_memory_table(gKRvKPrtbzData, "KRvKP.rtbz");
                ...
                load_file("KBPvK.rtbw");
                load_file("KBPvK.rtbz");
                load_file("KBvK.rtbw");
                load_file("KBvK.rtbz");
                load_file("KBvKB.rtbw");
                load_file("KBvKB.rtbz");
                load_file("KBvKN.rtbw");
                load_file("KBvKN.rtbz");
                load_file("KBvKP.rtbw");
                load_file("KBvKP.rtbz");
                load_file("KNNvK.rtbw");
                load_file("KNNvK.rtbz");
                load_file("KNPvK.rtbw");
                load_file("KNPvK.rtbz");
                load_file("KNvK.rtbw");
                load_file("KNvK.rtbz");
                load_file("KNvKN.rtbw");
                load_file("KNvKN.rtbz");
                ...
                load_file("KQvKP.rtbw");
                load_file("KQvKP.rtbz");
                ...
                load_file("KRvKN.rtbw");
                load_file("KRvKN.rtbz");
                load_file("KRvKP.rtbw");
                load_file("KRvKP.rtbz");
