...
// LOW_PLY_HISTORY_PLY_LIMIT (exclusive upper bound). With the limit set to 5,
// rows exist for plies {0, 2, 4} and not for plies {1, 3} or any ply >= 5.
constexpr int LOW_PLY_HISTORY_PLY_LIMIT = 5;
