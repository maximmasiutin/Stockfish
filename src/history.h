...
//   [608, 4704)  fallback for other NORMAL moves: (from << 6) | to
//   [4704, 4928) promotion / castling / en passant
//   [4928, 4930) sentinels for Move::none and Move::null
constexpr int HISTORY_SLOT_COUNT = 4930;
