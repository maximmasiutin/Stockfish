...
// Shared int8 continuation correction history (D=32, WDIV=16, RMUL=16)
constexpr int CONTCORR_D                 = 32;
constexpr int CONTCORR_SCALE             = 16;
constexpr int CONTCORR_FILL              = 0;
constexpr int CONTCORR_FALLBACK          = 4;
constexpr int CONTCORR_WEIGHT_MULTIPLIER = 2;
using CompactContCorrHist                = AtomicStats<std::int8_t, CONTCORR_D, PIECE_NB, SQUARE_NB>;
