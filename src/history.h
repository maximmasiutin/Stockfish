...
constexpr int LOW_PLY_HISTORY_LIMIT           = 7183;
constexpr int LowPlyMul[LOW_PLY_HISTORY_SIZE] = {32768, 16384, 10923, 8192, 6554};
...
using LowPlyHistory = MultiArray<std::int32_t, LOW_PLY_HISTORY_SIZE, UINT_16_HISTORY_SIZE>;
