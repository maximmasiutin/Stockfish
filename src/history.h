...
// Atomic version of LowPlyHistory for NUMA-shared access
using SharedLowPlyHistory =
  AtomicStats<std::int16_t, 7183, LOW_PLY_HISTORY_SIZE, UINT_16_HISTORY_SIZE>;
...
struct SharedHistories {
    ...
    SharedLowPlyHistory      lowPlyHistory;
