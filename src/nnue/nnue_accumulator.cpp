...
struct AccumulatorUpdateContext {
    ...
    void apply(const typename FeatureSet::IndexList& added,
        ...
        // Early warming: prefetch first two added columns to T2
        prefetch<PrefetchRw::READ, PrefetchLoc::LOW>(twBase + Dimensions * added[0]);
        prefetch<PrefetchRw::READ, PrefetchLoc::LOW>(twBase + Dimensions * added[1]);
