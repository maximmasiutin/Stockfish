...
struct AccumulatorUpdateContext {
    ...
    // 2-way unroll for 32-register architectures with 32 vector registers: x86-64-avx512, x86-64-avxvnni,
    // x86-64-avx512icl. AVX-VNNI added for comparison as a modern architecture but with 16 vector registers.
