...
struct AccumulatorUpdateContext {
    ...
    // 2-way unroll for 32-register architectures: x86-64-avx512, x86-64-avxvnni,
    // x86-64-vnni512, x86-64-avx512icl. AVX-512 has 32 ZMM. AVX-VNNI (EVEX)
    // has 32 YMM. Reduces loop overhead. Not for 16-register platforms.
    #if defined(USE_AVX512) || defined(USE_AVXVNNI)
            {
                int i = 0;
