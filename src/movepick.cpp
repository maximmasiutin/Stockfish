    ...
    for (auto move : ml)
    {
        ...
        else if constexpr (Type == QUIETS)
        {
            ...
            m.value +=
              2
              * (singleThread
                   ? threadLocalPawnHist[pawnKey & (PAWN_HISTORY_BASE_SIZE - 1)][pc][to]
                   : (l0PawnCache && l0PawnCache->contains(pawnKey)
                        ? l0PawnCache->get(pawnKey)[pc][to]
