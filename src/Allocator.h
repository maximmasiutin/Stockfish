...
Source: https://github.com/moya-lang/Allocator/blob/master/Allocator.h
...
#if defined(_WIN32)
#if __GNUC__ >= 5 // GCC 5.0
#define MODERN_WIN32_CPP_COMPILER
#endif
#if !defined(MODERN_WIN32_CPP_COMPILER)
#define ENABLE_OLD_WIN32_SUPPORT
