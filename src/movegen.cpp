...
// Frequency-aware mainHistory index. Defined in a TU (not the header) and
// without inline keyword so the compiler is free to inline or not via PGO
// across LTO. See research/mainhist-fa-attr-and-cache-experiments.md.
